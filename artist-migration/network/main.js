$(() => {
	...
	var promise_1 = $.when($.get({url:'data/fb_counts_18.json', dataType:'json'}), 
		$.get({url:'data/fb_links_18.json', dataType:'json'}))
	...
	var promise_2 = $.when($.get({url:'data/fb_counts_19.json', dataType:'json'}), 
		$.get({url:'data/fb_links_19.json', dataType:'json'}))
	.done((response1, response2) => {
	...
	var promise_3 = $.when($.get({url:'data/fb_counts_20.json', dataType:'json'}), 
		$.get({url:'data/fb_links_20.json', dataType:'json'}))
	.done((response1, response2) => {
