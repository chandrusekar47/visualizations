...
function group_by_continent_sort_by_year (all_data) {
	var grouped_by_continent = group_by("continent", all_data)
	grouped_by_continent.values().forEach((vals) => vals.sort((x,y) => x.century - y.century))
